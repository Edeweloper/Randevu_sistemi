...
namespace DAL.Migrations
{
    ...
    [Migration("20220829140644_created_user_role")]
    partial class created_user_role
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.Concrete.Arama", b =>
                {
                    ...
                    b.Property<DateTime>("Aranma_Zamanı")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Entity.Concrete.Randevular", b =>
                {
                    ...
                    b.Property<int>("Randevu_DurumuId")
                        .HasColumnType("integer");

                    b.Property<int>("Randevu_KaydedenId")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("Ziyaret_EdilenKisiId")
                        .HasColumnType("integer");

                    b.HasKey("Randevu_id");

                    b.HasIndex("Randevu_DurumuId");

                    b.HasIndex("Randevu_KaydedenId");

                    b.HasIndex("Ziyaret_EdilenKisiId");
            ...
            modelBuilder.Entity("Entity.Concrete.Randevular", b =>
                {
                    b.HasOne("Entity.Concrete.Randevu_durumu", "Randevu_Durumu")
                        .WithMany("Appoints")
                        .HasForeignKey("Randevu_DurumuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity.Concrete.AppUser", "Randevu_Kaydeden")
                        .WithMany()
                        .HasForeignKey("Randevu_KaydedenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity.Concrete.AppUser", "Ziyaret_EdilenKisi")
                        .WithMany()
                        .HasForeignKey("Ziyaret_EdilenKisiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Randevu_Durumu");

                    b.Navigation("Randevu_Kaydeden");

                    b.Navigation("Ziyaret_EdilenKisi");
                });

            modelBuilder.Entity("Entity.Concrete.UserRole", b =>
                {
                    b.HasOne("Entity.Concrete.AppUser", "Admin")
                        .WithMany()
                        .HasForeignKey("AdminId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity.Concrete.AppUser", "Sekreter")
                        .WithMany()
                        .HasForeignKey("SekreterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Admin");

                    b.Navigation("Sekreter");
                });
